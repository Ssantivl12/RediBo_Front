  ...
  return (
    <div className="border-2 border-gray-300 rounded-xl p-4 mt-4 relative z-10">
      ...
      <div className="flex flex-col gap-4">
        <DropdownHora label="Hora de recogida:" value={pickupTime} onChange={setPickupTime} />
        <DropdownHora label="Hora de devolución:" value={dropoffTime} onChange={setDropoffTime} disabledBefore={pickupTime} />
      </div>
    </div>
  );
}
