    ...
    <div className="border border-gray-300 rounded-xl p-4">
        ...
        />
            <div className="flex-1">
                ...
                <span 
                    className="text-sm text-gray-400 ml-2 cursor-not-allowed"
                    title="Funcionalidad en desarrollo"
                >
                Ver términos completos
                </span>
                </div>
                <div className="mt-2 text-base text-gray-600 max-h-[60px] overflow-y-auto">
                <p>
                    Al aceptar estos términos, confirmo que he leído y entendido las políticas de alquiler, 
